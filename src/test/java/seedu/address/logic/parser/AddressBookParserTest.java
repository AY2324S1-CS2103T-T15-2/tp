...
//         AddCommand command = (AddCommand) parser.parseCommand(PrescriptionUtil.getAddCommand(prescription));
...
//         Prescription prescription = new PrescriptionBuilder().build();
//         EditPrescriptionDescriptor descriptor = new EditPrescriptionDescriptorBuilder(prescription).build();
//         EditCommand command = (EditCommand) parser.parseCommand(EditCommand.COMMAND_WORD + " "
//                 + INDEX_FIRST_PERSON.getOneBased() + " " + PrescriptionUtil.getEditPrescriptionDescriptorDetails(descriptor));
