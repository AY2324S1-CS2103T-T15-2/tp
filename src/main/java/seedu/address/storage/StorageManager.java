...
public class StorageManager implements Storage {
    ...
    /**
     * Creates a {@code StorageManager} with the given {@code PrescriptionListStorage} and {@code UserPrefStorage}.
     */
    public StorageManager(PrescriptionListStorage prescriptionListStorage, UserPrefsStorage userPrefsStorage) {
